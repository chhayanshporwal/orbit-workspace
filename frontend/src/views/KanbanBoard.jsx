...
function TaskCard({ task, members, onDragStart, onDragEnd, onClick, overdue, isAdmin, currentUserId, activeDrags = {} }) {
  ...
  return (
    ...
    >
      {draggedByOther && (
        <div className="absolute top-0 right-0 rounded-bl-xl rounded-tr-xl bg-fuchsia-500 text-white text-[9px] font-black uppercase tracking-wider px-2 py-1 shadow-sm animate-pulse flex items-center gap-1 z-10">
          <Activity size={10} />
